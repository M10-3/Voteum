...
class candidat{
    ...
    public function __construct($username, $full_name, $email, $dob, $adresse, $biography, $program, $political_party, $image, $password, $id=null) {
        $this->id = $id;
        $this->username = $username;
        $this->full_name = $full_name;
        $this->email = $email;
...
class vote {
    ...
    public function __construct($id_elector, $id_candidat, $id_election, $id = null, $voted_at = null) {
        $this->id = $id;
...
class election {
    ...
    public function __construct($title, $image, $description,$start_date, $end_date, $is_active = true, $id_election = null) {
        $this->id_election = $id_election;
        $this->image = $image;
    ...
    public function setId($id_election) {
        $this->id_election = $id_election;
        return $this;
    }
    public function getImage() {
    ...
    public function getDescription() { // Changement de getName à getTitle
        return $this->description;
    }

    public function setDescription($description) { // Changement de setName à setTitle
        $this->description = $description;
        return $this;
    }
...
class admin{
    ...
    public function __construct($username, $email, $image, $password, $id_admin=null) {
