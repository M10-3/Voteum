...
if (empty(($errors))) {
    ...
    $query = $pdo->prepare('UPDATE admin SET confirmation_token = :token WHERE id_admin = :userId');
    ...
    $message = "Afin de confirmer votre compte, merci de cliquer sur ce lien\n\n
        http://localhost/gestion_vote/Back/view/confirm.php?id=$userId&token=$token";
