...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <h3>Biography</h3>
            <form id="biographyForm" action="http://localhost/gestion_vote/Front/controller/UpdateUsers.php"
                method="post">
                <div class="form-group">
                    <label for="actualBiography">Actual Biography:</label>
                    <input type="text" name="actualBiography" id="actualBiography"
                        value="<?php echo $_SESSION['biography']; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="newBiography">New Biography:</label>
                    <input type="text" name="newBiography" id="newBiography" placeholder="New Biography">
                </div>
                <span id="error_newBiography" class="error-message"></span>
                <input type="submit" value="Change My Biography">
            </form>
        </div>
        <!-- Program -->
        <div class="form-container">
            <h3>Program</h3>
            <form id="programForm" action="http://localhost/gestion_vote/Front/controller/UpdateUsers.php"
                method="post">
                <div class="form-group">
                    <label for="actualProgram">Actual Program:</label>
                    <input type="text" name="actualProgram" id="actualProgram"
                        value="<?php echo $_SESSION['program']; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="newProgram">New Program:</label>
                    <input type="text" name="newProgram" id="newProgram" placeholder="New Program">
                </div>
                <span id="error_newProgram" class="error-message"></span>
                <input type="submit" value="Change My Program">
            </form>
        </div>

<div class="form-container">
    <h3>Political Party</h3>
    <form id="political_partyForm" action="http://localhost/gestion_vote/Front/controller/UpdateUsers.php" method="post">
        <div class="form-group">
            <label for="actualPolitical_party">Actual Political Party:</label>
            <input type="text" name="actualPolitical_party" id="actualPolitical_party"
                value="<?php echo $_SESSION['political_party']; ?>" readonly>
        </div>
        <div class="form-group">
            <label for="newPolitical_party">New Political Party:</label>
            <input type="text" name="newPolitical_party" id="newPolitical_party" placeholder="New Political Party">
        </div>
        <span id="error_newPolitical_party" class="error-message"></span>
        <input type="submit" value="Change My Political Party">
    </form>
</div>
        ...
        <div class="form-container">
    <h3>Image</h3>
    <form id="imageForm" action="http://localhost/gestion_vote/Front/controller/UpdateUsers.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
